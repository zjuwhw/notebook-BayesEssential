...
Bayesian approach modifies the likelihood function into a *posterior distribution* by the classical Bayes' formula
(or theorem)
...
$$\pi(\sigma^2) = exp(-\sigma^{-2})|\frac{d\sigma^{-2}}{d\sigma^2}|=exp(-\sigma^{-2})(\sigma^2)^{-2}$$
(Note: see "Theorem 2.1.5" in the "Casella and Berger"), which is a special case of an inverse gamma distriubtion, namely $\mathcal{IG}(1,1)$.
